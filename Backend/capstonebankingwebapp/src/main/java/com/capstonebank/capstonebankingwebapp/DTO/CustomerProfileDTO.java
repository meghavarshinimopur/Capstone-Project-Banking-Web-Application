...
public class CustomerProfileDTO {
    ...
    private LocalDateTime createDate; // Account creation date
    ...
    private String role; // Role (e.g., "customer")
    ...
    private String avatarUrl; // Avatar URL based on gender
    private String accountType; // Account type (e.g., "Savings")
    private String branchCode; // Branch code
    private String branchName; // Branch name
    private String occupation; // Occupation
    private BigDecimal annualIncome; // Annual income
    private String address1; // Address line 1
    private String address2; // Address line 2 (optional)
